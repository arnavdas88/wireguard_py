...
class WireguardKey:
    ...
    keydata: bytes = field(metadata={"converter": convert_wireguard_key})

    def __post_init__(self):
        # Apply converter manually since dataclasses don't support them directly
        object.__setattr__(self, 'keydata', convert_wireguard_key(self.keydata))
